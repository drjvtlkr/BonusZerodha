    ...
    <>
      <div>
        ...
        <div className='flex flex-row'>
          <p className='ml-10  hover:border-b-2 hover:border-orange-500 hover:text-orange-500'> Orders</p>
          <p className='ml-10  hover:border-b-2 hover:border-orange-500 hover:text-orange-500'>GTT</p>
          <p className='ml-10  hover:border-b-2 hover:border-orange-500 hover:text-orange-500'>Baskets</p>
          <p className='ml-10  hover:border-b-2 hover:border-orange-500 hover:text-orange-500'>SIP</p>
          <p className='ml-10  hover:border-b-2 hover:border-orange-500 hover:text-orange-500'>Alerts</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          ...
          <div className="text-center">
            ...
            <div className='flex flex-row item-center justify-center mt-5 '>
              ...
              <p className='text-blue-600 ml-2 hover:text-orange-700'>View history</p>
            </div>
          </div>
        </div>
